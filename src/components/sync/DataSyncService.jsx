    ...
    for (let index = 0; index < accountResults.length; index++) {
      ...
      // Build and save call records for this account
       ...
       const accountCallRecords = accountResult.callRecords.map(call => ({
         ...
         is_working_hours: call.is_working_hours,
         qualified: call.qualified,
         sale_status: call.sale_status,
         first_time_caller: call.first_time_caller,
         keypress: call.keypress,
         web_source: call.web_source,
         web_medium: call.web_medium,
         web_campaign: call.web_campaign,
         web_campaign_id: call.web_campaign_id,
         web_keyword: call.web_keyword,
         web_visit_keywords: call.web_visit_keywords,
         web_ad_group_id: call.web_ad_group_id,
         web_adgroup_id: call.web_adgroup_id,
         web_creative_id: call.web_creative_id,
         web_ad_network: call.web_ad_network,
         web_ad_match_type: call.web_ad_match_type,
         web_ad_slot: call.web_ad_slot,
         web_ad_slot_position: call.web_ad_slot_position,
         web_ad_targeting_type: call.web_ad_targeting_type,
         ...
         sync_date: call.sync_date || syncDateStr
       }));
